...
public class Satelite implements Mediador{
    ...
    public void enviar(String mensaje) {
        System.out.println("Enviando desde satélite el mensaje " + mensaje);
    ...
    public void recibir(String mensaje) {
        System.out.println("Recibiendo desde satélite el mensaje " + mensaje);
    }
